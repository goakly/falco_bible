...
<div class="container-md">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                ...
                <center>
                    ...
                    <br>
                    <br>
                    <a class="btn btn-warning btn-lg" data-toggle="collapse" data-target="#demo">Sign Up!
                    </a>
                </center>
            </div>
            ...
            <div class="item">
                ...
                <center>
                    ...
                    <br>
                    <br>
                    <a class="btn btn-success btn-lg ribbon" data-toggle="collapse" data-target="#demo">Get Tickets!
                    </a>
                </center>
            </div>
            ...
            <div class="item">
                ...
                <center>
                    ...
                    <br>
                    <br>
                    <a class="btn btn-danger btn-lg ribbon" data-toggle="collapse" data-target="#demo">Sponsorship
                        Information!
                    </a>
                </center>
            </div>
    ...
    <div id="events" class="well collapse">
        ...
        <center>
            ...
            <button class="btn btn-danger" data-toggle="collapse" data-target="#attend">Complete Event List
            </button>
        </center>
    ...
    <div id="attend" class="well collapse">
        ...
        <center>
            <button class="btn btn-success" data-toggle="collapse" data-target="#attend">Purchase Tickets!
            </button>
        </center>
    </div>
</div>
